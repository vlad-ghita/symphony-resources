...
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (15, 4, 'an-example-draft-article', 'An example draft article');
...
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (15, 4, 'This is an example draft article. Feel free to test the system by pressing the *publish* button.', '<p>This is an example draft article. Feel free to test the system by pressing the <em>publish</em> button.</p>\n');
...
INSERT INTO`tbl_entries_data_3` (`id`, `entry_id`, `value`, `date`) VALUES (15, 4, '2012-03-10T21:21:00+10:00', '2012-03-10 11:21:00');
...
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `relation_id`) VALUES (15, 4, 2);
...
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `value`) VALUES (15, 4, 'no');
...
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (4, 1, 1, '2011-07-21 15:06:00', '2011-07-21 05:06:00', '2013-01-06 14:15:52', '2013-01-06 12:15:52');
...
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (137, 'mailchimp', 'enabled', 1.19);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (138, 'resources', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (139, 'resources_pages', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (140, 'resources_widgets', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (141, 'resources_datasources', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (142, 'resources_events', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (143, 'resources_js', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (144, 'resources_css', 'enabled', 1.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (145, 'resources_images', 'enabled', 1.0);
...
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (236, 137, '/system/preferences/', 'AddCustomPreferenceFieldsets', 'addCustomPreferenceFieldsets');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (237, 138, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (238, 138, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (239, 139, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (240, 139, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (241, 139, '/frontend/', 'FrontendOutputPreGenerate', 'dFrontendOutputPreGenerate');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (242, 139, '/blueprints/pages/', 'PagePostCreate', 'dPagePostCreate');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (243, 139, '/blueprints/pages/', 'PagePreEdit', 'dPagePreEdit');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (244, 139, '/blueprints/pages/', 'PagePostEdit', 'dPagePostEdit');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (245, 139, '/blueprints/pages/', 'PagePreDelete', 'dPagePreDelete');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (246, 139, '/blueprints/pages/', 'PagePostDelete', 'dPagePostDelete');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (247, 139, '/frontend/', 'FrontendPageResolved', 'dFrontendPageResolved');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (248, 140, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (249, 140, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (250, 141, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (251, 141, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (252, 142, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (253, 142, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (254, 143, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (255, 143, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (256, 144, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (257, 144, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (258, 145, '/frontend/', 'FrontendInitialised', 'dFrontendInitialised');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (259, 145, '/backend/', 'InitaliseAdminPageHead', 'dInitialiseAdminPageHead');
...
-- *** DATA:`tbl_pages` ***
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (64, NULL, 'Home', 'home', NULL, 'category', 'article_images,homepage_articles,notes', NULL, 1);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (66, NULL, 'About', 'about', NULL, NULL, 'website_owner', 'save_message', 5);
...
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (68, NULL, 'Archive', 'archive', NULL, 'year', 'archive', NULL, 4);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (69, NULL, 'Articles', 'articles', NULL, 'entry/cat', 'article,article_images,comments', 'save_comment', 2);
INSERT INTO`tbl_pages` (`id`, `parent`, `title`, `handle`, `path`, `params`, `data_sources`, `events`, `sortorder`) VALUES (70, NULL, 'Drafts', 'drafts', NULL, 'entry', 'article_images,drafts', 'publish_article', 3);
...
INSERT INTO`tbl_pages_types` (`id`, `page_id`, `type`) VALUES (684, 70, 'admin');
INSERT INTO`tbl_pages_types` (`id`, `page_id`, `type`) VALUES (656, 75, 'hidden');
INSERT INTO`tbl_pages_types` (`id`, `page_id`, `type`) VALUES (682, 64, 'index');
INSERT INTO`tbl_pages_types` (`id`, `page_id`, `type`) VALUES (683, 69, 'hidden');
...
INSERT INTO`tbl_pages_types` (`id`, `page_id`, `type`) VALUES (681, 64, 'hidden');
